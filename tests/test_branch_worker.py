...
class TestBranchWorker(unittest.IsolatedAsyncioTestCase):
    ...
    def test_full_sync_with_mirror_fallback_repo(self) -> None:
        ...
        bw = BranchWorkerMock(mirror_dir=TEST_MIRROR_DIRECTORY, mirror_fallback_repo=fallback_repo)
    ...
    def test_full_sync_without_mirror_fallback_repo(self) -> None:
        bw = BranchWorkerMock(mirror_dir=TEST_MIRROR_DIRECTORY, mirror_fallback_repo=None)
        mirror_path = os.path.join(
            TEST_MIRROR_DIRECTORY, os.path.basename(TEST_UPSTREAM_REPO_URL)
        )
        with (
